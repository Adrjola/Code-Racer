...
import { soloRaceApi, type SubmitProgressResponse } from './soloRaceApi';

function isProgressAck(response: SubmitProgressResponse): response is { acceptedOffset: number } {
