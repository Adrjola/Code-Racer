  ...
  return (
    <div className="flex min-h-[100dvh] items-center justify-center bg-surface px-4 font-sans">
      <section className={panelClassName}>
        ...
        {isPersonalBest && (
          <p className="inline-flex items-center gap-2 rounded-full border border-amber-300/40 bg-amber-300/10 px-3 py-1 font-mono text-[11px] font-bold uppercase tracking-wide text-amber-200">
            <span aria-hidden>★</span> New personal best
          </p>
        )}

        <p className="mt-5 flex items-end gap-3">
          <span className="font-mono text-[clamp(3.5rem,10vw,5rem)] font-extrabold leading-none text-text-primary">
            {cpm ?? '--'}
          </span>
        ...
        <dl className="mt-7 grid grid-cols-1 gap-3 sm:grid-cols-2">
          <div className={`${tileClassName} border-amber-300/25`}>
            <dt className="flex items-center gap-2 text-[11px] uppercase tracking-wide text-amber-200/80">
              <span aria-hidden>◷</span> Best time
            </dt>
          ...
          <div className={`${tileClassName} border-purple-400/25`}>
            <dt className="flex items-center gap-2 text-[11px] uppercase tracking-wide text-purple-200/80">
              <span aria-hidden>▮</span> Global rank
            </dt>
