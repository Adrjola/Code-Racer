...
class CurrentJwtUserProviderTest {

  private final CurrentJwtUserProvider provider = new CurrentJwtUserProvider();
  ...
  void resolvesUserIdFromJwtClaim() {
    ...
    assertThat(provider.resolve()).isEqualTo(userId);
  }
  ...
  void rejectsMissingAuthentication() {
    ...
    assertThrows(MissingCurrentUserException.class, () -> provider.resolve());
  }
